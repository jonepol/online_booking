...
<html>
	 ...
	 <body>
	 	  ...
	 	  <div id="content">
	 	  	<form name="personDetail" method="POST" onsubmit="return personal_detail_alidation()" action="payment.php">
	 			<table>
	 				<tr>
	 				...
	 				<tr>
						<td class="fieldlabel">Suburb:<span class="half-compulsory"> *</span></td>
